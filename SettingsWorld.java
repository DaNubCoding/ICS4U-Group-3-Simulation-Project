...
public class SettingsWorld extends PixelWorld {
    ...
    private Slider slider1 = new Slider(1, 5, 25, new Color(229, 115, 115));
    private Slider slider2 = new Slider(1, 5, 25, new Color(54, 119, 122));
    private Slider slider3 = new Slider(0, 60, 60, new Color(76, 45, 23));
