...
public abstract class TierOneFish extends Fish
{
    ...
    /**
     * Sets fish settings for tier one fish, according to defaults, while specifying the different body image and egg color
     * 
     ...
     */
    public static void initialiseTierOneFishSettings(FishSettings settings, String bodyImage, Egg.EggColor eggColor){
        // Base settings
        settings.setBaseValue(100);
        settings.setBodyImage(bodyImage);
        settings.setCatchOffset(13, 15);    
